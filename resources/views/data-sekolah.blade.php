        ...
        <div class="grid grid-cols-1 gap-5 mt-4 lg:mt-8 md:grid-cols-3">
          ...
          <div data-aos="fade-up"
            ...
            <div class="flex items-center justify-between w-full gap-5">
              ...
              <h5 class="font-bold tracking-tight text-7xl text-colorsecondpurple font-outfit">{{ $staff }}</h5>
            </div>
        ...
        <div class="grid grid-cols-1 gap-5 mt-4 lg:mt-8 md:grid-cols-3">
          ...
          <div data-aos="fade-up"
            ...
            <div class="flex items-center justify-between w-full gap-5">
              ...
              <h5 class="font-bold tracking-tight text-7xl text-colorsecondyellowtua font-outfit">{{ $siswa_laki }}</h5>
            </div>
          ...
          <div data-aos="fade-up"
            ...
            <div class="flex items-center justify-between w-full gap-5">
              ...
              <h5 class="font-bold tracking-tight text-7xl text-colorprimarytosca font-outfit">{{ $siswa_perempuan }}</h5>
            </div>
          ...
          <div data-aos="fade-up"
            ...
            <div class="flex items-center justify-between w-full gap-5">
              ...
              <h5 class="font-bold tracking-tight text-7xl text-colorprimaryorange font-outfit">{{ $semua_siswa }}</h5>
            </div>
        ...
        <div class="grid grid-cols-1 gap-5 mt-4 lg:mt-8 md:grid-cols-3">
          ...
          <div data-aos="fade-up"
            ...
            <div class="flex items-center justify-between w-full gap-5">
              ...
              <h5 class="font-bold tracking-tight text-7xl text-colorprimarytosca font-outfit">{{ $total_ruangan }}</h5>
            </div>
