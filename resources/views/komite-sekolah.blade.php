...
<html lang="en">
  <head>
        ...
        <title>Komite Sekolah | SD ISLAM NURUL FIRDAUS</title>
      ...
      <div class="container">
        <div class="flex items-center justify-center gap-2 py-4">
          ...
          <h1 data-aos="fade-up"
              ...
              data-aos-once="false"
              data-aos-anchor-placement="top-center" 
              class="text-2xl font-bold text-center lg:text-3xl text-colorprimarytosca font-outfit">Komite Sekolah</h1>
