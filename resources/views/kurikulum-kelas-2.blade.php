      ...
      <div class="container">
        <div class="flex items-center justify-center gap-2 py-4">
          ...
          <h1 data-aos="fade-up"
              ...
              data-aos-once="false"
              data-aos-anchor-placement="top-center" 
              class="text-2xl font-bold text-center lg:text-3xl text-colorprimarytosca font-outfit">Kurikulum PPK (Pendidikan Penguatan Karakter) Kelas 2</h1>
        ...
        <div class="w-full mx-auto mt-4 md:w-4/5">
          ...
          <div tabindex="0" class="mb-2 border collapse border-base-300 collapse-arrow bg-colorsecondtoscamuda">
            <div class="text-sm font-medium md:text-xl collapse-title font-outfit text-colorprimarytosca">{{ $d->materi }}</div>
