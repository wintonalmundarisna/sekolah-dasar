...
<html lang="en">
  <head>
        ...
        <title>Info Tenaga Pendidik | SD ISLAM NURUL FIRDAUS</title>
                ...
                <a class="flex items-center justify-center cursor-default bg-cover bg-no-repeat bg-center overflow-hidden h-[200px]">
                  ...
                  @else
                    <img src="{{ asset('assets/default-teacher.jpg') }}"
                      class="w-full bg-cover bg-no-repeat bg-center rounded-t-lg overflow-hidden" alt="foto-pendidik">
                  @endif
                </a>
              </div>
              <div class="py-3">
