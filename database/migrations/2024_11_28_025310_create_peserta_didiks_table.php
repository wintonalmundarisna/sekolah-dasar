...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('peserta_didiks', function (Blueprint $table) {
            ...
            $table->string('nama-ayah', 100)->nullable();
            $table->string('tahun-lahir-ayah', 5);
            $table->string('jenjang-pendidikan-ayah', 50)->nullable();
            $table->string('pekerjaan-ayah', 100)->nullable();
            $table->string('penghasilan-ayah')->nullable();
            $table->string('nik-ayah', 20)->nullable();
            $table->string('nama-ibu', 100);
            $table->string('tahun-lahir-ibu', 5);
            $table->string('jenjang-pendidikan-ibu', 50)->nullable();
            $table->string('pekerjaan-ibu', 100);
            $table->string('penghasilan-ibu');
            ...
            $table->string('penghasilan-wali')->nullable();
